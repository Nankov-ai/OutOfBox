...
CREATE TABLE "User" (
    ...
    "name" TEXT,
    "avatarUrl" TEXT,
    "preferredLocale" TEXT NOT NULL DEFAULT 'pt',
...
-- CreateIndex
CREATE UNIQUE INDEX "Session_Auth_sessionToken_key" ON "Session_Auth"("sessionToken");
...
-- CreateIndex
CREATE UNIQUE INDEX "JournalEntry_sessionId_key" ON "JournalEntry"("sessionId");
...
-- AddForeignKey
ALTER TABLE "JournalEntry" ADD CONSTRAINT "JournalEntry_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "ChatSession"("id") ON DELETE SET NULL ON UPDATE CASCADE;
